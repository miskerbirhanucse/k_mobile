...
import 'package:kirayup/model/popular_village.dart';

import 'package:kirayup/model/villa_characteristic.dart';
      ...
      children: <Widget>[
        ...
        SizedBox(
          ...
          child: ListView.builder(
            ...
            itemCount: vila.length,
            itemBuilder: (BuildContext context, int index) {
              PopularVillage popularVillage = village[index];
